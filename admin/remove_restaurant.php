...
if(isset($_POST['remove-rest'])){
    $rname = $_POST['rname'];

    $rest->remove_restaurant($rname);
}
?>
...
<body class="d-flex flex-row" style="height: 150vb; font-family: 'Poppins', sans-serif;">
    ...
    <div class="content m-5">
        <h1 class="mb-5">Remove restaurant</h1>
        <form action="" method="post">
            ...
            <div>
                <input class="btn btn-primary border-0 px-5" style="background-color:#1b2136;" type="submit" name="remove-rest" value="Remove">
            </div>
        </form>
    </div>
