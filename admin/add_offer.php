...
if(isset($_POST['add-offer'])){
    ...
    $offerdes = $_POST['offerdes'];
    $restid = $_POST['restid'];

    $admin->add_offer($itemname,$itemcost,$offerdes,$restid);
}
?>
...
<body class="d-flex flex-row" style="height: 150vb; font-family: 'Poppins', sans-serif;">
    ...
    <div class="content m-5">
        <h1 class="mb-5">Add offer</h1>
        <form action="" method="post">
            <div class="one mb-3">
                <label for="inputrname" class="form-label" style="color:#1b2136;">offer-item</label>
                <input type="text" name="itemname" class="form-control w-100 border border-3 border-dark-subtle" id="inputrname" placeholder="offer-item....">
            </div>
            <div class="one mb-3">
                <label for="inputrdec" class="form-label" style="color:#1b2136;">offer-cost</label>
                <input type="text" name="itemcost" class="form-control w-100 border border-3 border-dark-subtle" id="inputrdec" placeholder="offer-cost....">
            </div>
            <div class="one mb-3">
                <label for="inputrstatus" class="form-label" style="color:#1b2136;">offer-des</label>
                <input type="text" name="offerdes" class="form-control w-100 border border-3 border-dark-subtle" id="inputrstatus" placeholder="offer-des....">
            </div>
            <div class="one mb-5">
                <label for="inputrimage" class="form-label" style="color:#1b2136;">Restaurant-id</label>
                <input type="text" name="restid" class="form-control w-100 border border-3 border-dark-subtle" id="inputrimage" placeholder="Restaurant-id....">
            </div>
            <div>
                <input class="btn btn-primary border-0 px-5" style="background-color:#1b2136;" type="submit" name="add-offer" value="Add">
            </div>
        </form>
    </div>
